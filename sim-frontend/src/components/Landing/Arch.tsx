...
const Arch = () => {
    return (
      <section className="w-[100vw] text-[#eeeeee] lg:flex hidden flex-col justify-center items-center fadeInScroll">
        ...
        /> */}
        <h1 className="text-[39px] font-medium text-center max-w-[60%]">Stake <span className={`${brandSecondaryText}`}>$AOEth</span> at projects built on arweave and recieve their <span className={`${brandSecondaryText}`}>$tokens</span> </h1>
